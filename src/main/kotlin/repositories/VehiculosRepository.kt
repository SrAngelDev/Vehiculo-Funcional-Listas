...
interface VehiculosRepository : CrudRepository<Vehiculo, Int> {
    ...
    fun averageBy(selector: (Vehiculo) -> Double, predicate: (Vehiculo) -> Boolean = { true }): Double
    ...
    fun sortedBy(mode: ModoOrdenamiento = ModoOrdenamiento.ASCENDENTE, condition: (Vehiculo) -> Double): Array<Vehiculo>
}
